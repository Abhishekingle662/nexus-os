  ...
  useEffect(() => {
    ...
    function open() {
      ...
      ws.onmessage = (event) => {
        ...
        if (data.type === "mission_complete" || data.type === "error") setIsRunning(false);
      };
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white p-8 font-mono">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-zinc-500 mb-10">GPT-4o Mini • Agent Swarm</p>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6 h-155 overflow-y-auto">
          <div className="flex items-center gap-3 mb-6 sticky top-0 bg-zinc-900 pb-4 border-b border-zinc-800">
            ...
            {currentTask && <span className="text-emerald-400 text-sm ml-auto truncate max-w-xs">→ {currentTask}</span>}
          </div>
